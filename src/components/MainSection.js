      ...
      <Box justifyContent="center" display={['inline', 'flex']}>
        ...
        <Box w={["95%", "40%"]} py={[5, 20]} textAlign="center" fontFamily="oswaldbold" fontWeight={500} color="black">
          ...
          <Box py={5} textAlign="center">
            <Link href={` ${section.whatsapp}`} target="_blank" display="block" height="70px" width={["100%", "488px"]} borderRadius="5px" margin="auto" backgroundColor={section.ctaBackgroundColor.hex} color={section.ctaColor.hex}>
