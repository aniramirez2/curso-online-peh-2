...
return (
  <Box py={[5,8]} height={["auto", "auto"]} key={section.sectionType} backgroundImage="url('https://storage.builderall.com//franquias/2/6203456/editor-html/6882458.png')" color={section.textColor.hex} id={section.sectionType} fontFamily="oswaldbold">
    ...
    <Box display={['inline', 'flex']} px={[0, 7]}>
      ...
      <Box textAlign="center" w={["88%", "60%"]} margin="auto" mb={5} lineHeight={["1.1em","1.7em"]} fontWeight="500" fontFamily="oswaldbold">
        {
    ...
    <Box textAlign="center" my={5}>
      <Link href={`https://api.whatsapp.com/send?phone=${section.whatsapp}`} target="_blank" display="block" height="70px" width={["88%","488px"]} borderRadius="5px" margin="auto" boxShadow="#6a6a6a" backgroundColor={section.ctaBackgroundColor.hex} fontFamily="oswaldbold">
